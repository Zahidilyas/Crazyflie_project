...
if("TRUE" STREQUAL "TRUE")
  set(crazyflie_controller_SOURCE_PREFIX /home/zahid/dd2419_ws/src/course_packages/crazyflie_ros/crazyflie_controller)
  set(crazyflie_controller_DEVEL_PREFIX /home/zahid/dd2419_ws/devel/.private/crazyflie_controller)
  ...
  set(crazyflie_controller_INSTALL_PREFIX /home/zahid/dd2419_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'crazyflie_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zahid/dd2419_ws/src/course_packages/crazyflie_ros/crazyflie_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zahid/dd2419_ws/devel/.private/crazyflie_controller/lib;/home/zahid/dd2419_ws/devel/lib;/opt/ros/melodic/lib)
